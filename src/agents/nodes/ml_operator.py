...
class MLFinding(BaseModel):
    ...
    handoff_target: Literal["user", "errand-runner", "homelab-engineer", "storage-operator", "smart-home-operator"] = "user"
...
def _build_llm() -> BaseChatModel:
    ...
    ).with_structured_output(MLFinding)  # type: ignore[return-value]
